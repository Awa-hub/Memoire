                   ...
                   <!-- start widget -->
					<div class="state-overview">
						...
						<?php
									...
									$allMaleEleves = $traitement->getEleveBySexe('Masculin'); // On recupère tous les garçons
									$allFemaleEleves = $traitement->getEleveBySexe('Feminin'); // On recupère tous les filles

									$allClasses = $traitement->getAllClasse(); // On recupère tous les classes

									$num = 1; 

									// $allMaleEleves = $traitement->getEleveBySexeAndClasse('Masculin'); // On recupère tous les garçons par classe
                                    // $allFemaleEleves = $traitement->getEleveBySexeAndClasse('Feminin'); // On recupère tous les filles par classe
                                ?>
